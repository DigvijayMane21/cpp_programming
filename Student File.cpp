...
int main()
{
    int i,n,ch,ch1,rec,start,cnt,add,n1,add2,start2;
    int n2,y,a,b,on,oname,add3,start3,n3,y1,add4,start4,n4;
    ...
    {
        cout<<"\n>>>>>>>>>>>>>>>>>>>>>>MENU<<<<<<<<<<<<<<<<<<<<";
        cout<<"\n1.Insert and overwrite"<<endl;
        cout<<"2.Show"<<endl;
        cout<<"3.Search & Edit(number)"<<endl;
        cout<<"4.Search & Edit(name)"<<endl;
        cout<<"5.Search & Edit(onlynumber)"<<endl;
        cout<<"6.Search & edit(only name)"<<endl;
