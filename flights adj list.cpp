...
void addEdge(string cities[], bool visited[], bool added[], const string& source, const string& destination, int& count)
{
    cities[count++] = source;
...
bool isConnected(string cities[], const bool visited[], const bool added[], int count)
{
    if (count == 0)
        return true;
